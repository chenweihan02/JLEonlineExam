        ...
        <div class="nr_left">
            <div class="test">
                <c:forEach items="${questionList}" var="question">
                    <form action="question?method=update" method="post">
                        <div class="test_content">
                            <div class="test_content_title">
                                ...
                                <font><input type="submit" name="test_jiaojuan" value="保存"></font>
                            </div>
                        </div>
                            ...
                            <ul>
                                <li id="qu_0_0">
                                    <div class="test_content_nr_tt">
                                        题目：<input type="text" name="q_title" id="q_title" class="q_input" value="${question.title}" />
                                        <input type="hidden" name="q_id" value="${question.id}">
                                    </div>
                                    <div class="test_content_nr_main">
                                        <ul>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_1_option_1" value="A"/>
                                                <label for="0_answer_1_option_1">
                                                    A.
                                                    <p class="ue" style="display: inline;"><input type="text" name="q_a" id="q_a" class="q_input" value="${question.attrA}" /></p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_1_option_2" value="B"/>
                                                <label for="0_answer_1_option_2">
                                                    B.
                                                    <p class="ue" style="display: inline;"><input type="text" name="q_b" id="q_b" class="q_input" value="${question.attrB}" /></p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_1_option_3" value="C"/>
                                                <label for="0_answer_1_option_3">
                                                    C.
                                                    <p class="ue" style="display: inline;"><input type="text" name="q_c" id="q_c" class="q_input" value="${question.attrC}" /></p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_1_option_4" value="D"/>
                                                <label for="0_answer_1_option_4">
                                                    D.
                                                    <p class="ue" style="display: inline;"><input type="text" name="q_d" id="q_d" class="q_input" value="${question.attrD}" /></p>
                                                </label>
                                            </li>
                                        </ul>
                                    </div>
