...
<div class="main">
    ...
    <div class="test_main">
        <div class="nr_left">
            <div class="test">
                <form action="exam?method=judge" method="post">
                            ...
                            <c:forEach items="${questionList}" var="question">
                                <li id="qu_${question.index}">
                                    ...
                                    <div class="test_content_nr_main">
                                        <ul>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer${question.id}" id="0_answer_${question.index}_option_1" value="A"/>
                                                <label for="0_answer_${question.index}_option_1">
                                                    A.
                                                    <p class="ue" style="display: inline;">${question.attrA}</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_${question.index}_option_2" value="B"/>
                                                <label for="0_answer_${question.index}_option_2">
                                                    B.
                                                    <p class="ue" style="display: inline;">${question.attrB}</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_${question.index}_option_3" value="C"/>
                                                <label for="0_answer_${question.index}_option_3">
                                                    C.
                                                    <p class="ue" style="display: inline;">${question.attrC}</p>
                                                </label>
                                            </li>
                                            <li class="option">
                                                <input type="radio" class="radioOrCheck" name="answer1" id="0_answer_${question.index}_option_4" value="D"/>
                                                <label for="0_answer_${question.index}_option_4">
                                                    D.
                    ...
                    <input type="submit" name="test_jiaojuan" value="交卷">
                </form>
            </div>
        </div>
        <div class="nr_right">
                ...
                <div class="rt_nr1">
                    ...
                    <div class="rt_content">
                        ...
                        <div class="rt_content_nr answerSheet">
                            <ul>
                                <c:forEach items="${questionList}" var="question">
                                    <li><a href="#qu_${question.index}">${question.index}</a></li>
                                </c:forEach>
                            </ul>
                        </div>
                    </div>
