<%--User: xiaochen Date: 2021/6/17 Time: 7:15--%>
    ...
    <div class="menux">
        <p>
            <i class="fa fa-user-circle-o"></i> <i
                class="fa fa-angle-right point"></i> 管理员权限权限
        </p>
        <ul>
            <li><a href="javascript:void(0);" url="../../admin?action=log" title="所有考试列表">
                    <i class="fa fa-caret-right"></i> 查看日志</a>
            </li>
...
<div class="main">
    ...
    <iframe name="mainFrame" src="introduce2.jsp" width="100%" height="90%" frameborder="0px"></iframe>
</div>
</body>
</html>
